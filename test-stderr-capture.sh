...
python3 << 'EOF'
import sqlite3
conn = sqlite3.connect('/root/projects/agents-manager/api/data/database.db')
...
RESPONSE=$(curl -s -X POST \
  ...
  -d '{"name":"stderr-test","workspace_path":"/root/projects/agents-manager/projects/agents-manager/agents/planner"}' \
