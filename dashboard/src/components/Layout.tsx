...
import { Settings, Users, Workflow, AlertCircle, FolderOpen, Zap, MessageSquare, LayoutGrid } from 'lucide-react'
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-gray-900 text-white">
        ...
        <nav className="mt-6">
          ...
          <NavItem icon={<LayoutGrid size={20} />} label="Kanban" href="/kanban" isActive={location.pathname === '/kanban'} />
