        ...
        'agents': [
            {
                'name': 'planner',
                'role': 'planner',
                'workspace_path': '/root/projects/agents-manager/projects/agents-manager/agents/planner'
            },
            {
                'name': 'coder-backend',
                'role': 'coder',
                'workspace_path': '/root/projects/agents-manager/projects/agents-manager/agents/coder-backend'
            },
            {
                'name': 'reviewer',
                'role': 'reviewer',
                'workspace_path': '/root/projects/agents-manager/projects/agents-manager/agents/reviewer'
            }
        ]
    }
...
"""
    ...
    assert 'agents-manager' in prompt, "Project name missing"
    ...
    assert '/root/projects/agents-manager' in prompt, "Project path missing"
