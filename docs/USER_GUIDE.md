...
Welcome to agents-manager! This comprehensive guide will help you get started with creating projects, agents, plans and workflows.
...
This section defines the visual language and component patterns for the agents-manager dashboard. All new UI must follow these patterns to maintain consistency.
